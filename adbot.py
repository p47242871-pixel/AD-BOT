...
DEFAULT_CONFIG = {
    "host_usernames": ["Zed9._"],
    "admin_usernames": ["Zed9._"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "665d9799c74200b80ed54459")
    api_token = os.getenv("API_TOKEN", "3c212f088a4063242b1e0791e84bb74d106b86b502886ef9b58c61b6aa06ed5e")
